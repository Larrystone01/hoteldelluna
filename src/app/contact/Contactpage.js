  ...
  return (
    <Slider images={["/images/hall.jpg"]}>
      <NavAndFooterWrap>
        <SeoPage
          hidden
          title="Contact Hotel Del Luna in Ilorin"
          intro="Reach out to us for room reservations, inquiries, or support. Our friendly team is available to assist you promptly."
          sections={[
            {
              heading: "Get in Touch",
              content:
                "Whether you have questions about rooms, services, or your upcoming stay, our team is ready to help via phone, email, or our contact form.",
            },
            {
              heading: "Reservation Assistance",
              content:
                "Need help booking a room? Contact us directly and we’ll guide you through the process quickly and efficiently.",
            },
            {
              heading: "Customer Support",
              content:
                "For any concerns during your stay, our support team is available to provide immediate assistance and ensure your comfort.",
            },
          ]}
          schema={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              {/* Map Placeholder */}
              <div className="bg-white rounded-2xl shadow-xl p-4 w-full overflow-hidden">
