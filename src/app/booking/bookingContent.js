    ...
    <>
      <Slider images={[sliderImage]}>
        <NavAndFooterWrap>
          <SeoPage
            hidden
            title="Book Your Stay at Hotel Del Luna"
            intro="Easily reserve your room or suite at Hotel Del Luna in Ilorin. Quick, secure, and transparent online booking for a seamless stay."
            sections={[
              {
                heading: "Quick & Secure Booking",
                content:
                  "Choose your dates, select a room, and confirm your reservation within minutes. All bookings are safe and secure.",
              },
              {
                heading: "Luxury Rooms & Suites",
                content:
                  "Select from our range of comfortable and elegantly designed rooms, tailored for business and leisure travelers.",
              },
              {
                heading: "Instant Confirmation",
                content:
                  "Once booked, receive instant confirmation of your reservation. No delays or waiting times.",
              },
            ]}
            schema={{
              ...
              potentialAction: {
                "@type": "ReserveAction",
                target: "https://hoteldelluna.vercel.app/booking",
                result: {
                  ...
                  <div className="grid md:grid-cols-3 gap-6 md:p-8 p-4">
                    ...
                    <div className="md:col-span-2 order-2">
                      ...
                      <div className="space-y-5">
                        ...
                        {!bookingId && (
                          <button
                            className={`w-full bg-indigo-600 text-white font-bold py-4 rounded-lg hover:from-indigo-700 hover:to-purple-700 transform hover:scale-[1.02] transition-all shadow-lg cursor-pointer flex justify-center items-center gap-2`}
